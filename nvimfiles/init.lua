...
vim.keymap.set('n', '<leader>g', ':term lazygit<Cr>')
...
require('lazy').setup({
  ...
  },
  {
    ...
    opts = {},
    keys = {
      { '<leader><space>', ':NvimTreeToggle<cR>' },
  ...
  },
  {
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>j', ':SplitjoinSplit<cr>')
      vim.keymap.set('n', '<leader>k', ':SplitjoinJoin<cr>')
    end,
  },
